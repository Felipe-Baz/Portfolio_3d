...
const About = () => {
  return (
    <>
      ...
      >
        Sou um desenvolvedor de software qualificado com experiência em .NET e
        Python e expertise em frameworks como FastApi e Node.js. Eu aprendo rápido e colaboro de perto com os clientes para
